...
<center>
    <font color="red">Dak Report Detail</font>
</center><br>
<div class="container">
    <div class="modal-body border">
        <form action="g_reportTableDak.php" method="post" enctype="multipart/form-data">
            <div class="container">
                <div class="row">
        ...
        <!--<div class="col" style="overflow:auto; max-height: 400px;">-->
            <table id="myTable" class="table table-striped table-bordered table-sm bg-white">
                <thead class="thead-dark">
                    <tr>
                        <th scope="col"><span class="Hindi">कर्मचारी का नाम</span><span class="English">Name Of Employee</span></th>
                ...
                <tbody id="filterTb">
                    ...
                    if (isset($_REQUEST["date1"]) && isset($_REQUEST["date2"])) {
                        ...
                        $sql1 = "SELECT * FROM g_dak_details where GATE_MEN = '$name' AND DATE BETWEEN '$a' and  '$b' ORDER BY `DATE` DESC ";
                    } else {
                        // $gname = $_REQUEST['gname'];
                        $sql1 = "SELECT * FROM g_dak_details where GATE_MEN = '$name' order by DATE DESC";
                    }
                    $i = 1;
