...
<center>
    <font color="red">Employee Report Detail</font>
</center><br>
<div class="container">
    <div class="modal-body border">
        <form action="g_reportTableEmp.php" method="post" enctype="multipart/form-data">
            <div class="container">
                <div class="row">
            ...
            <table id="myTable" class="table table-striped table-bordered table-sm bg-white">
                ...
                <tbody id="filterTb">
                    ...
                    if (isset($_REQUEST["date1"]) && isset($_REQUEST["date2"])) {
                        ...
                        $sql1 = "SELECT * FROM g_gateentryemp where GATE_MEN = '$name' AND ENTRY_DATE BETWEEN '$a' and  '$b' ORDER BY `ENTRY_DATE` DESC ";
                    } else {
                        // $gname = $_REQUEST['gname'];
                        $sql1 = "SELECT * FROM g_gateentryemp where GATE_MEN = '$name' order by ENTRY_DATE DESC";
                    }
                    $i = 1;
